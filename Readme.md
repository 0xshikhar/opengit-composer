...
[Download `opengit-composer-3.0.0.vsix`](https://github.com/0xshikhar/opengit-composer/releases/download/v3.0.0/opengit-composer-3.0.0.vsix)

Then install it with:

```bash
code --install-extension opengit-composer-3.0.0.vsix
```
